  ...
  files.".clangd".yaml = {
    CompileFlags = {
      Add = [
        ...
        "-std=c++14"           # Mbed OS 6+ typically uses C++14 or C++17
        "--include-directory=${pkgs.gcc-arm-embedded}/arm-none-eabi/include/c++/10.3.1"
        "--include-directory=${pkgs.gcc-arm-embedded}/arm-none-eabi/include/c++/10.3.1/arm-none-eabi"
      ];
      CompilationDatabase = ".";
    };
  };
